        ...
        <div data-scroll data-scroll-section data-scroll-speed="-.4"  className='w-full  py-20'>
            <div className='footer_container px-16 flex'>
                ...
                <div className='w-full flex '>
                    <div className='px-10 relative w-1/2 py-4'>
                        <svg className='absolute bottom-0' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='relative text-zinc-400 w-1/2 flex justify-between flex-row px-10'>
                        <h6 className='absolute bottom-0'>&copy;ochi design 2024. Legal Terms</h6>
                        <h6 className='absolute right-2 bottom-0'>Website by Obys</h6>
                    </div>
            </div>
        </div>
    )
