...
function About() {
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-0.3" className='w-full  py-28  rounded-t-3xl text-black bg-[#8C7466]'>
            <div className='px-20'>
            ...
            <div className='border-t-[1px] w-full max-2xl:py-5 border-[#9bae58] mt-[3vw] flex max-md:flex-col gap-5'>
                <div className='px-20 max-sm:w-full max-2xl:w-1/2'>
                    ...
                    <button className='max-:py-2 max-lg:px-5 max-2xl:py-4 max-2xl:px-10 bg-black text-white uppercase rounded-full mt-6 flex max-sm:gap-2 p-5 max-sm:text-xl max-sm:w-fullmax-2xl:gap-5 items-center'>Read more
                        <div className='w-2 h-2 pr-4 ml-3 bg-zinc-100 rounded-full'></div>
                    </button>
                </div>
                <div className=' max-md:w-[90vw] max-2xl:w-1/2 mt-10 h-[70vh] max-2xl:mx-10  overflow-hidden '>
