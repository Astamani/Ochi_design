...
function Navbar() {
  ...
  return (
    <div
      className={`fixed z-[999] w-full px-20 py-5 flex justify-between items-center font-["Neun Montreal"] transition-transform duration-500 ${isVisible ? 'translate-y-0' : '-translate-y-full'
        }`}
      style={{
