...
function Marque() {
  return (
    ...
    <div data-scroll data-scroll-section data-scroll-speed="-0.3" className='w-full py-20 mb-0 bg-[#004D43]  rounded-t-3xl'>
      <div className='overflow-hidden mt-1 text text-start border-t-[1px] border-b-[1px] flex whitespace-nowrap text-[19vw] leading-none font-semibold  font-custom '>
